   ...
   if(window.innerWidth>=1080){
    ...
    if(this.ls.getItem('LocationId'))
    {
      ...
      this.meta.updateTag({ 
        ...
        this.meta.updateTag({ 
          name: 'description',
          content: 'Looking for professional beautician courses in dubai?  Mirrors Beauty is the training institute in Dubai. Get trained with advanced beauty therapy courses at our academy. Full time, part time or weekend batch available. Hurry Up! Enter into the world of beauty.'
      });
      this.meta.updateTag({ 
        name: 'keywords',
        content: 'beauty salon training, beauty parlour course, beautician course near me, professional beautician course, beautician course in dubai, beauty salon courses, beautician training centre, beauty academy dubai,  beauty therapy course,'
    });
      }
    }
