...
@Component({
  selector: 'app-cidesco',
  templateUrl: './cidesco.component.html',
  styleUrls: ['./cidesco.component.css']
})
export class CidescoComponent implements OnInit {
  ...
  updateMetaDescription(newDescription: string) {
    console.log("🚀 ~ updateMetaDescription ~ newDescription:", newDescription)
